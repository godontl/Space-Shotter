...
public class MessageButton {
    ...
    static {
        try {
            ...
            customFont = Font.createFont(Font.TRUETYPE_FONT, MessageButton.class.getResourceAsStream("1up.ttf"));
            customFont = customFont.deriveFont(Font.PLAIN, 18); // Imposta la dimensione del font

            littlecustomFont = Font.createFont(Font.TRUETYPE_FONT, MessageButton.class.getResourceAsStream("VCR_OSD_MONO_1.001.ttf"));
            littlecustomFont = littlecustomFont.deriveFont(Font.PLAIN, 15);

            smallcustomFont = Font.createFont(Font.TRUETYPE_FONT, MessageButton.class.getResourceAsStream("VCRosdNEUE.ttf"));
